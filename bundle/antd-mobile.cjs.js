 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa = React__default["default"], m = objectAssign, r = scheduler.exports;
function y(a) {
...
function renderImperatively(element) {
  const Wrapper2 = React__default["default"].forwardRef((_, ref) => {
    ...
    return React__default["default"].cloneElement(element, Object.assign(Object.assign({}, element.props), {
      visible,
      onClose,
      afterClose
    }));
...
function usePropsValue(options) {
  ...
  const setState = ahooks.useMemoizedFn((v) => {
...
const Calendar = React$1.forwardRef((p, ref) => {
  ...
  const [current, setCurrent] = React$1.useState(() => dayjs__default["default"](dateRange ? dateRange[0] : today).date(1));
  ...
  }, React__default["default"].createElement(ArrowLeftDouble, null)), React__default["default"].createElement("a", {
    className: `${classPrefix$17}-arrow-button`,
    onClick: () => {
      setCurrent(current.subtract(1, "month"));
    }
  }, React__default["default"].createElement(ArrowLeft, null)), React__default["default"].createElement("div", {
  ...
  }, React__default["default"].createElement(ArrowLeft, null)), React__default["default"].createElement("a", {
    className: `${classPrefix$17}-arrow-button ${classPrefix$17}-arrow-button-right`,
    onClick: () => {
...
const useIsomorphicUpdateLayoutEffect = ahooks.createUpdateEffect(ahooks.useIsomorphicLayoutEffect);
...
const ScrollMask = (props) => {
  ...
  const {
    run: updateMask
  } = ahooks.useThrottleFn((immediate = false) => {
...
const Wheel = React$1.memo((props) => {
  ...
  function renderAccessible() {
    ...
    }, "-"), React__default["default"].createElement("div", null, previous && React__default["default"].createElement("div", {
    ...
    }, "-")), React__default["default"].createElement("div", null, next && React__default["default"].createElement("div", {
      className: "adm-picker-view-column-accessible-button",
      onClick: () => {
...
const Picker$1 = React$1.memo((p) => {
  ...
  const onChange = ahooks.useMemoizedFn((val, ext) => {
    var _a2;
    setInnerValue(val);
    if (props.visible) {
  ...
  return React__default["default"].createElement(React__default["default"].Fragment, null, popupElement, (_a = props.children) === null || _a === void 0 ? void 0 : _a.call(props, extend.items));
});
...
const Collapse = (props) => {
  ...
  return withNativeProps(props, React__default["default"].createElement("div", {
    ...
    const renderArrow = () => {
      let arrow = React__default["default"].createElement(antdMobileIcons.DownOutline, null);
...
function generateDatePickerColumns$2(selected, min, max, precision, renderLabel, filter) {
  ...
  const generateColumn = (from, to, precision2) => {
    let column = [];
    for (let i = from; i <= to; i++) {
      column.push(i);
    }
...
function generateDatePickerColumns$1(selected, min, max, precision, renderLabel, filter) {
  ...
  const isInMinYear = selectedYear === minYear;
  const isInMaxYear = selectedYear === maxYear;
  const minDay = dayjs__default["default"](min);
  const maxDay = dayjs__default["default"](max);
  ...
  const selectedYearWeeks = dayjs__default["default"](`${selectedYear}-01-01`).isoWeeksInYear();
  const generateColumn = (from, to, precision2) => {
    let column = [];
    for (let i = from; i <= to; i++) {
      column.push(i);
...
function convertDateToStringArray$1(date) {
  if (!date)
    return [];
  const day = dayjs__default["default"](date);
...
const DatePicker = (p) => {
  ...
  const now = React$1.useMemo(() => new Date(), []);
  ...
  const onSelect = ahooks.useMemoizedFn((val) => {
    var _a;
...
const Image$1 = stagedComponents.staged((p) => {
...
const Dialog = (p) => {
  ...
  const body = React__default["default"].createElement("div", {
    ...
    className: classNames__default["default"](cls$1("content"), !props.content && cls$1("content-empty"))
    ...
    return React__default["default"].createElement("div", {
      ...
      key: action.key,
      action,
      onAction: () => tslib.__awaiter(void 0, void 0, void 0, function* () {
        var _a, _b, _c;
  ...
  const node = withNativeProps(props, React__default["default"].createElement("div", {
    className: cls$1(),
    style: {
      display: active ? "unset" : "none"
    }
  ...
  return new Promise((resolve) => {
    show$2(Object.assign(Object.assign({}, props), {
      ...
      actions: [[{
        ...
        onClick: () => tslib.__awaiter(this, void 0, void 0, function* () {
          var _a;
...
const ErrorBlock = (p) => {
  ...
  if (props.image) {
    if (typeof props.image === "string") {
      imageNode = React__default["default"].createElement("img", {
        src: props.image,
...
const FloatingBubble = (p) => {
  ...
  return withNativeProps(props, React__default["default"].createElement("div", {
    ...
    style: {
      opacity,
      transform: web.to([x, y2], (x2, y3) => `translate(${x2}px, ${y3}px)`)
    },
    onClick: props.onClick,
...
const FloatingPanel = React$1.forwardRef((p, ref) => {
  ...
  const onHeightChange = ahooks.useMemoizedFn((_b = props.onHeightChange) !== null && _b !== void 0 ? _b : () => {
  });
  const [{
    y: y2
  }, api] = web.useSpring(() => ({
  ...
  return withNativeProps(props, React__default["default"].createElement(web.animated.div, {
    ...
    ref: headerRef
  }, headerChildren || React__default["default"].createElement("div", {
...
const FormArray = (props) => {
  return React__default["default"].createElement(RcForm.List, {
    ...
    if (props.renderAdd) {
      children.push(React__default["default"].createElement(List, {
        key: "add",
        mode: "card"
      }, React__default["default"].createElement(List.Item, {
...
const Form$1 = React$1.forwardRef((p, ref) => {
  const props = mergeProps(defaultProps$y, p);
  const {
    className,
    style,
  ...
  function collect() {
    if (items.length === 0)
      return;
    count += 1;
    lists.push(React__default["default"].createElement(List, {
  ...
  function update() {
    ...
    return tslib.__awaiter(this, void 0, void 0, function* () {
      ...
      const {
        ...
        middlewareData
      } = yield dom.computePosition(target, floating2, {
        placement,
        middleware: [dom.offset(convertPx(12)), dom.shift({
          padding: convertPx(4),
          crossAxis: false,
          limiter: dom.limitShift()
        }), dom.flip(), dom.hide(), dom.arrow({
...
const FormItem = (props) => {
  const {
    ...
    clickable,
    arrow
  } = props, fieldProps = tslib.__rest(props, ["className", "style", "label", "help", "extra", "hasFeedback", "name", "required", "noStyle", "hidden", "layout", "childElementPosition", "description", "disabled", "rules", "children", "messageVariables", "trigger", "validateTrigger", "onClick", "shouldUpdate", "dependencies", "clickable", "arrow"]);
  const {
    name: formName
  ...
  return React__default["default"].createElement(RcForm.Field, Object.assign({}, fieldProps, {
    name,
    shouldUpdate,
    dependencies,
    rules,
...
const MultiImageViewer = React$1.forwardRef((p, ref) => {
  ...
  const [defaultIndex, setDefaultIndex] = React$1.useState(props.defaultIndex);
...
const ImageUploader = (p) => {
  ...
  return withNativeProps(props, React__default["default"].createElement("div", {
    ...
    return React__default["default"].createElement(PreviewItem, {
      ...
      onDelete: () => tslib.__awaiter(void 0, void 0, void 0, function* () {
        var _c;
...
const Modal = (p) => {
  ...
  const body = React__default["default"].createElement("div", {
    ...
    direction: "vertical",
    block: true,
    className: classNames__default["default"](cls("footer"), props.actions.length === 0 && cls("footer-empty"))
  }, props.actions.map((action, index2) => {
...
const NumberKeyboard = (p) => {
  ...
  const onDelete = ahooks.useMemoizedFn(() => {
    var _a;
  ...
  const renderHeader = () => {
    ...
    return React__default["default"].createElement("div", {
      ...
      role: "button",
      title: "CLOSE"
    }, React__default["default"].createElement(antdMobileIcons.DownOutline, null)));
  };
...
const PullToRefresh = (p) => {
  ...
  const [springStyles, api] = web.useSpring(() => ({
    from: {
      height: 0
    },
    config: {
  ...
  function doRefresh() {
    return tslib.__awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        api.start({
          to: (next) => tslib.__awaiter(this, void 0, void 0, function* () {
            yield next({
              height: 0
            });
            setStatus("pulling");
...
const defaultProps$g = {
  count: 5,
  allowHalf: false,
  character: React__default["default"].createElement(antdMobileIcons.StarFill, null),
  defaultValue: 0,
  readOnly: false,
  allowClear: true
};
...
const iconRecord = {
  ...
  info: antdMobileIcons.InformationCircleFill,
  waiting: antdMobileIcons.ClockCircleFill,
  warning: antdMobileIcons.ExclamationCircleFill
};
const Result = (props) => {
  const {
    status,
...
const defaultProps$f = {
  ...
  defaultValue: "",
  clearOnCancel: true,
  icon: React__default["default"].createElement(antdMobileIcons.SearchOutline, null)
};
...
const Swiper = React$1.forwardRef(stagedComponents.staged((p, ref) => {
  ...
  return () => {
    ...
    const bind = react.useDrag((state) => {
      ...
      if (!state.last) {
        ...
        const maxIndex = minIndex + 1;
        const index2 = Math.round((offset + velocity * 2e3 * direction) / slidePixels);
...
const TabBar = (p) => {
  ...
  return withNativeProps(props, React__default["default"].createElement("div", {
    ...
    return withNativeProps(item.props, React__default["default"].createElement("div", {
      ...
      className: classNames__default["default"](`${classPrefix$7}-item`, {
...
const Tag = (p) => {
  ...
  return withNativeProps(props, React__default["default"].createElement("span", {
    style,
    onClick: props.onClick,
    className: classNames__default["default"](classPrefix$6, {
...
const InternalToast = (p) => {
  ...
  const iconElement = React$1.useMemo(() => {
    ...
    switch (icon) {
      case "success":
        return React__default["default"].createElement(antdMobileIcons.CheckOutline, null);
      case "fail":
        return React__default["default"].createElement(antdMobileIcons.CloseOutline, null);
      case "loading":
  ...
  return React__default["default"].createElement(Mask, {
    ...
    className: classNames__default["default"](`${classPrefix$4}-mask`, props.maskClassName),
    stopPropagation: props.stopPropagation
  }, React__default["default"].createElement("div", {
    className: classNames__default["default"](`${classPrefix$4}-wrap`)
  }, React__default["default"].createElement("div", {
    style: {
      top
    },
    className: classNames__default["default"](`${classPrefix$4}-main`, icon ? `${classPrefix$4}-main-icon` : `${classPrefix$4}-main-text`)
...
function show(p) {
  ...
  const TempToast = React$1.forwardRef((_, ref2) => {
    const [visible, setVisible] = React$1.useState(true);
    React$1.useEffect(() => {
      return () => {
        var _a;
    ...
    React$1.useImperativeHandle(ref2, () => ({
      close: () => setVisible(false)
    }));
    return React__default["default"].createElement(InternalToast, Object.assign({}, props, {
  ...
  ReactDOM.render(React__default["default"].createElement(TempToast, {
    ref
  }), container);
  return {
    close: () => {
...
const TreeSelect = (p) => {
  ...
  const renderItems = (columnOptions = [], index2) => {
    return columnOptions.map((item) => {
      ...
      return React__default["default"].createElement("div", {
        key: item[valueName],
        className: classNames__default["default"](`${classPrefix$3}-item`, {
  ...
  const renderColumns = () => {
    ...
    for (let i = 0; i < deep; i++) {
      ...
      const column = React__default["default"].createElement("div", {
        key: i,
        className: classNames__default["default"](`${classPrefix$3}-column`),
        style: {
          width
        }
...
const Multiple = (p) => {
  ...
  const renderSelectAllLeafItem = (columnOptions, index2) => {
    ...
    return React__default["default"].createElement("div", {
      ...
      className: classNames__default["default"](`${classPrefix$2}-item`, `${classPrefix$2}-item-leaf`)
  ...
  const renderItem = (option) => {
    ...
    return React__default["default"].createElement("div", {
      ...
      className: classNames__default["default"](`${classPrefix$2}-item`, {
  ...
  const renderColumns = () => {
    ...
    for (let i = 0; i < deep; i++) {
      ...
      const column = React__default["default"].createElement("div", {
        key: i,
        className: classNames__default["default"](`${classPrefix$2}-column`),
        style: {
          width
        }
...
const VirtualInput = React$1.forwardRef((p, ref) => {
  ...
  return withNativeProps(props, React__default["default"].createElement("div", {
    ref: rootRef,
    className: classNames__default["default"](classPrefix$1, {
  ...
  }, React__default["default"].createElement(antdMobileIcons.CloseCircleFill, null)), !value && React__default["default"].createElement("div", {
...
exports.ActionSheet = index$h;
exports.AutoCenter = AutoCenter;
exports.Avatar = Avatar;
exports.Badge = Badge;
exports.Button = Button;
exports.Calendar = Calendar;
exports.CapsuleTabs = index$g;
exports.Card = Card;
exports.CascadePicker = index$f;
...
exports.DatePicker = index$c;
exports.DatePickerView = DatePickerView;
exports.Dialog = index$b;
exports.Divider = Divider;
exports.DotLoading = DotLoading;
exports.Dropdown = index$a;
...
exports.IndexBar = index$8;
exports.InfiniteScroll = InfiniteScroll;
exports.Input = Input;
exports.JumboTabs = index$7;
exports.List = List;
