...
var FormItemLayout = function FormItemLayout(props) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_list["default"].Item, {
    ...
    className: (0, _classnames["default"])(classPrefix, className, (_classNames = {}, _classNames[classPrefix + "-hidden"] = hidden, _classNames[classPrefix + "-error"] = feedback, _classNames)),
    disabled: disabled,
